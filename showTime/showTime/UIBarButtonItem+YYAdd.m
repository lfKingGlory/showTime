...
- (void)setActionBlock:(void (^)(id sender))block {
    ...
    objc_setAssociatedObject(self, &ms_block_key, target, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void (^)(id)) actionBlock {
    _YYUIBarButtonItemBlockTarget *target = objc_getAssociatedObject(self, &ms_block_key);
    return target.block;
}
