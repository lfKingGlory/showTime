...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.imageViewLeft.contentMode = UIViewContentModeScaleToFill;
        ...
        self.imageViewCenter.contentMode = UIViewContentModeScaleToFill;
        ...
        self.imageViewRight.contentMode = UIViewContentModeScaleToFill;
...
- (void)setUrlArray:(NSArray<NSString *> *)urlArray
{
    ...
    [self.imageViewCenter sd_setImageWithURL:[NSURL URLWithString:urlArray[self.indexCurrent]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
    [self.imageViewLeft sd_setImageWithURL:[NSURL URLWithString:urlArray[indexLeft]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
    [self.imageViewRight sd_setImageWithURL:[NSURL URLWithString:urlArray[indexRight]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
...
- (void)reloadImage
{
    ...
    [self.imageViewCenter sd_setImageWithURL:[NSURL URLWithString:self.urlArray[self.indexCurrent]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
    
    self.scrollView.contentOffset = CGPointMake(self.frame.size.width, 0);
    
    indexLeft = (self.indexCurrent + self.urlArray.count - 1) % self.urlArray.count;
    indexRight = (self.indexCurrent + 1) % self.urlArray.count;
    [self.imageViewLeft sd_setImageWithURL:[NSURL URLWithString:self.urlArray[indexLeft]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
    [self.imageViewRight sd_setImageWithURL:[NSURL URLWithString:self.urlArray[indexRight]] placeholderImage:self.placeholderImage options:SDWebImageAllowInvalidSSLCertificates];
}
